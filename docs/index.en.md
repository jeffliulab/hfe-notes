  ...
  <section class="home-hero">
    ...
    <div class="home-stat-grid">
      <div class="home-stat">
        ...
        <span class="home-stat__label">source files</span>
      </div>
      <div class="home-stat">
        <span class="home-stat__value">8,374</span>
        <span class="home-stat__label">text units</span>
      </div>
      <div class="home-stat">
        <span class="home-stat__value">149</span>
        <span class="home-stat__label">visuals</span>
      </div>
      <div class="home-stat">
        <span class="home-stat__value">2</span>
        <span class="home-stat__label">languages</span>
      </div>
    </div>
  </section>
  ...
  <section class="home-section home-section--flow">
    ...
    <div class="home-flow-grid">
      ...
      <article class="home-flow-step">
        ...
        <h3>Open a topic</h3>
        <p>Move into the relevant concept, method, or case page.</p>
      </article>
      <article class="home-flow-step">
        <span class="home-flow-step__no">03</span>
        <h3>Check visuals</h3>
        <p>Use extracted figures and previews alongside the explanation.</p>
      </article>
      <article class="home-flow-step">
        <span class="home-flow-step__no">04</span>
        <h3>Verify appendix</h3>
        <p>Finish with the line-by-line source appendix.</p>
      </article>
    </div>
  </section>
