...
这页讲的是“已经发生的事件如何被解释”。
后面的 task analysis、
URRA 和 operational risk 页，
则把这种解释能力往前推，
用来在出事之前识别结构性风险。

<figure class="note-inline-figure">
  <img src="https://jeffliulab.github.io/hfe-notes/assets/visuals/sp26-erroranalysismethods-20260121/page-02.png" alt="这张图要看懂的是：错误分析不是独立存在的方法，它处在理论、案例和 mitigation 之间，调查输出必须最终回到改进动作。" loading="lazy">
  <figcaption>这张图要看懂的是：错误分析不是独立存在的方法，它处在理论、案例和 mitigation 之间，调查输出必须最终回到改进动作。</figcaption>
</figure>

## 为什么时间线是错误分析里最不能省的一层

很多团队以为时间线只是“把事情按先后写出来”。
实际上时间线的作用更深，
它是后面所有因果判断的骨架。
只要事件顺序没理清，
团队就很容易把后果错当原因，
...
以及恢复窗口是什么时候真正关闭的。
时间线一旦稳住，
后面的 system conditions 才能被放回正确位置。
...
如果一份报告里只有“发生了什么”和“以后注意”，
那通常还不是课程里要求的 error analysis，
而只是带结论的复述。

!!! example "案例：为什么同一份材料会被写成“事故复述”和“系统分析”两种完全不同的东西"
    同样是一次给药错误，
    弱调查会写成“护士误选药物，
    导致患者受到错误治疗”；
    强调查会继续拆出包装相似性、
...
| --- | --- | ---: | ---: | --- |
| `Sp26_Investigative Process-NTSB_20260121.pdf` | `pdf` | 267 | 3 | [open](../assets/source_files/ENP112/Sp26_Investigative Process-NTSB_20260121.pdf) |
| `Sp26_ErrorAnalysisMethods_20260121.pdf` | `pdf` | 317 | 3 | [open](../assets/source_files/ENP112/Sp26_ErrorAnalysisMethods_20260121.pdf) |

## 相关主题

- [人为失误框架](../ENP111/human_error_frameworks.md)
- [任务分析](../ENP111/task_analysis.md)
...
??? info "Sp26_Investigative Process-NTSB_20260121.pdf | 267 text units"
    下载原件: [Sp26_Investigative Process-NTSB_20260121.pdf](../assets/source_files/ENP112/Sp26_Investigative Process-NTSB_20260121.pdf)
    映射页面: `error_analysis_methods`
...
??? info "Sp26_ErrorAnalysisMethods_20260121.pdf | 317 text units"
    下载原件: [Sp26_ErrorAnalysisMethods_20260121.pdf](../assets/source_files/ENP112/Sp26_ErrorAnalysisMethods_20260121.pdf)
    映射页面: `error_analysis_methods`
